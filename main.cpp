...
int CntlinkedEdge(int i, int j) {
    return CheckLinkedEdge(TopLine) + CheckLinkedEdge(DownLine) + CheckLinkedEdge(LeftLine) + CheckLinkedEdge(RightLine);
}

int CntBannedEdge(int i, int j) {
    return CheckBannedEdge(TopLine) + CheckBannedEdge(DownLine) + CheckBannedEdge(LeftLine) + CheckBannedEdge(RightLine);
}
